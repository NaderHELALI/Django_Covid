...
from .models import Demande, Product, Compte , Item
...
def contact(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            c = Compte(nom=nom, email=email, mot_de_passe=mot_de_passe, numero_tel=numero_tel, adresse=adresse, nombre=nombre,
                       membre1=membre1, membre2=membre2, membre3=membre3, membre4=membre4, membre5=membre5, membre6=membre6)
            c.save()
